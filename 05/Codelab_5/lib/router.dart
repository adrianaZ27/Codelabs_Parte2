      ...
      child: Selector<RouterProvider, ReplyRoutePath?>(
        ...
        builder: (context, routePath, child) {
          return Navigator(
            ...
            pages: [
              // TODO: Add Shared Z-Axis transition from search icon to search view page (Motion) - obtiene la transicion definida
...
//Crea Transicion de eje compartido - boton busqueda
